...
public class Conector 
{
    ...
    public final boolean getFile(String ftpPath, String destPath, String fileName) throws JSchException, SftpException, IllegalAccessException
    {
    	if (this.session != null && this.session.isConnected()) 
        { 
            // Abrimos un canal SFTP. Es como abrir una consola.
            ...
            System.out.println(String.format("Descargando archivo %s en el " + "directorio %s", fileName, ftpPath));
